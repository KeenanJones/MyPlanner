 ...
 * 
 * This class represents a business department. It holds any published business plans for the department
 * along with a default template for users to create a 'blank' plan
 */
